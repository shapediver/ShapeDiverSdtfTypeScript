...
import { SdtfGeometryConeType, SdtfGeometryTypeGuard, SdtfGeometryTypeIntegration } from "../../src"

describe("type cone", function () {

    let sdk: SdtfSdk
    const content: SdtfGeometryConeType = {
    ...
    test("read and get content; should not throw", async () => {
        ...
        SdtfGeometryTypeGuard.assertCone(content)
    })
    ...
    test("create via writer; should contain value", () => {
        ...
        const writeableAsset = constructor.getWriter().createSimpleDataSdtf("", [ {
            content,
            typeHint: SdtfGeometryTypeHintName.GEOMETRY_CONE,
        } ])
