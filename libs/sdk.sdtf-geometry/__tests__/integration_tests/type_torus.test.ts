...
import { SdtfGeometryTorusType, SdtfGeometryTypeGuard, SdtfGeometryTypeIntegration } from "../../src"

describe("type torus", function () {

    let sdk: SdtfSdk
    const content: SdtfGeometryTorusType = {
    ...
    test("read and get content; should not throw", async () => {
        ...
        SdtfGeometryTypeGuard.assertTorus(content)
    })
    ...
    test("create via writer; should contain value", () => {
        ...
        const writeableAsset = constructor.getWriter().createSimpleDataSdtf("", [ {
            content,
            typeHint: SdtfGeometryTypeHintName.GEOMETRY_TORUS,
        } ])
