...
import { SdtfGeometryArcType, SdtfGeometryTypeGuard, SdtfGeometryTypeIntegration } from "../../src"

describe("type arc", function () {

    let sdk: SdtfSdk
    const content: SdtfGeometryArcType = {
    ...
    test("read and get content; should not throw", async () => {
        ...
        SdtfGeometryTypeGuard.assertArc(content)
    })
    ...
    test("create via writer; should contain value", () => {
        ...
        const writeableAsset = constructor.getWriter().createSimpleDataSdtf("", [ {
            content,
            typeHint: SdtfGeometryTypeHintName.GEOMETRY_ARC,
        } ])
