...
export class SdtfBinarySdtf implements ISdtfBinarySdtf {
    ...
    readHeader (header: DataView | ArrayBuffer): [ number, number ] {
        ...
        if (magic !== "sdtf") throw new SdtfError(`Invalid identifier: Unknown file type for sdTF identifier '${ magic }'.`)

        const version = header.getUint32(4, true)
        if (version !== 1) throw new SdtfError(`Invalid version: Unsupported sdTF version '${ version }'.`)
        ...
        if (contentFormat !== 0) throw new SdtfError(`Invalid content: Unsupported sdTF content format '${ contentFormat }'.`)
