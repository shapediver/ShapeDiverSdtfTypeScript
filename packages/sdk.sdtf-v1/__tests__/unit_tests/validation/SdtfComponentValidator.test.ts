...
describe('validateAccessor', function () {
    const validator: ISdtfComponentValidator = new SdtfComponentValidator(
        createComponentList({
    ...
    test('invalid - bufferView not a uint; should throw', () => {
        ...
        expect(() => validator.validateAccessor(accessor)).toThrow(
            /Required property 'bufferView' must be an unsigned integer/
        );
    ...
    test('invalid - bufferView out of range; should throw', () => {
        ...
        expect(() => validator.validateAccessor(accessor)).toThrow(
            /Buffer view index is out of range/
        );
    });
});
...
describe('validateAsset', function () {
    ...
    test('invalid - fileInfo not a uint; should throw', () => {
        ...
        expect(() => validator.validateAsset(asset)).toThrow(
            /Required property 'fileInfo' must be an unsigned integer/
        );
...
describe('validateAttributes', function () {
    ...
    test('invalid - entries not an object; should throw', () => {
        ...
        expect(() => validator.validateAttributes(attributes)).toThrow(
            /Required property 'entries' must be a string-keyed object/
        );
    });
    ...
    test('invalid - typeHint not a uint; should throw', () => {
        ...
        expect(() => validator.validateAttributes(attributes)).toThrow(
            /Required property 'typeHint' must be an unsigned integer/
        );
    ...
    test('invalid - accessor not a uint; should throw', () => {
        ...
        expect(() => validator.validateAttributes(attributes)).toThrow(
            /Optional property 'accessor' must be an unsigned integer/
        );
    });
    ...
    test('invalid- typeHint out of range; should throw', () => {
        ...
        expect(() => validator.validateAttributes(attributes)).toThrow(
            /Type hint index is out of range/
        );
    });
});
...
describe('validateBuffer', function () {
    ...
    test('invalid - byteLength not a uint; should throw', () => {
        ...
        expect(() => validator.validateBuffer(buffer)).toThrow(
            /Required property 'byteLength' must be an unsigned integer/
        );
...
describe('validateBufferView', function () {
    ...
    test('invalid - buffer not a uint; should throw', () => {
        // missing
        let bufferView = factory.createBufferView({
            byteLength: 0,
            byteOffset: 0,
            contentType: 'text',
        });
        expect(() => validator.validateBufferView(bufferView)).toThrow(
            /Required property 'buffer' must be an unsigned integer/
        );

        // missing
        bufferView = factory.createBufferView({
            buffer: -1,
            byteLength: 0,
            byteOffset: 0,
            contentType: 'text',
    ...
    test('invalid - byteOffset not a uint; should throw', () => {
        ...
        expect(() => validator.validateBufferView(bufferView)).toThrow(
            /Required property 'byteOffset' must be an unsigned integer/
        );
    ...
    test('invalid - contentType not a uint; should throw', () => {
        ...
        expect(() => validator.validateBufferView(bufferView)).toThrow(
            /Required property 'contentType' must be a non-empty string/
        );
...
describe('validateChunk', function () {
    ...
    test('invalid - name not a string; should throw', () => {
        ...
        expect(() => validator.validateChunk(bufferView)).toThrow(
...
describe('validateDataItem', function () {
    ...
    test('invalid - typeHint not a uint; should throw', () => {
        ...
        expect(() => validator.validateDataItem(dataItem)).toThrow(
            /Required property 'typeHint' must be an unsigned integer/
        );
    ...
    test('invalid - attributes not a uint; should throw', () => {
        ...
        expect(() => validator.validateDataItem(dataItem)).toThrow(
            /Optional property 'attributes' must be an unsigned integer/
        );
    });
    ...
    test('invalid - attributes out of range; should throw', () => {
        const dataItem = factory.createDataItem({ typeHint: 0, attributes: 1 });
        expect(() => validator.validateDataItem(dataItem)).toThrow(
            /Attributes index is out of range/
        );
    });
...
describe('validateFileInfo', function () {
    ...
    test('invalid - version not a non-empty string; should throw', () => {
        ...
        expect(() => validator.validateFileInfo(fileInfo)).toThrow(
            /Required property 'version' must be a non-empty string/
        );
...
describe('validateTypeHint', function () {
    ...
    test('invalid - name not a non-empty string; should throw', () => {
        ...
        expect(() => validator.validateTypeHint(typeHint)).toThrow(
...
describe('validateChunkOrNode', function () {
    const validator: SdtfComponentValidator = new SdtfComponentValidator(
        createComponentList({
            attributes: [factory.createAttributes({})],
    ...
    test('invalid - attributes is not a uint; should throw', () => {
        ...
        expect(() => validator.validateChunkOrNode(node)).toThrow(
            /Optional property 'attributes' must be an unsigned integer/
        );
    });
    ...
    test('invalid - items  is not a uint array; should throw', () => {
        ...
        expect(() => validator.validateChunkOrNode(node)).toThrow(
            /Required property 'items' must be an array of unsigned integers/
        );
    ...
    test('invalid - nodes is not a uint array; should throw', () => {
        ...
        expect(() => validator.validateChunkOrNode(node)).toThrow(
            /Required property 'nodes' must be an array of unsigned integers/
        );
    ...
    test('invalid - typeHint is not a uint; should throw', () => {
        ...
        expect(() => validator.validateChunkOrNode(node)).toThrow(
            /Optional property 'typeHint' must be an unsigned integer/
        );
    });
    ...
    test('invalid - self-referencing node; should throw', () => {
        ...
        expect(() => validator.validateChunkOrNode(node)).toThrow(
            /Node is referencing itself in the 'nodes' property/
        );
    });
});
...
function createComponentList(
    partialList: Partial<ISdtfPartialComponentList>
): ISdtfPartialComponentList {
    return {
