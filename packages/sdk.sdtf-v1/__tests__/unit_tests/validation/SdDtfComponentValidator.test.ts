import { SdDtfPartialAsset } from "../../../src/structure/components/SdDtfPartialAsset"
import { SdDtfPartialFileInfo } from "../../../src/structure/components/SdDtfPartialFileInfo"
import { ISdDtfPartialComponentList } from "../../../src/structure/ISdDtfComponentList"
import { SdDtfComponentFactory } from "../../../src/structure/SdDtfComponentFactory"
import { ISdDtfComponentValidator } from "../../../src/validation/ISdDtfComponentValidator"
import { SdDtfComponentValidator } from "../../../src/validation/SdDtfComponentValidator"

const factory = new SdDtfComponentFactory()

describe("validateAccessor", function () {

    const validator: ISdDtfComponentValidator = new SdDtfComponentValidator(createComponentList({
...
describe("validateChunkOrNode", function () {
    ...
    const validator: SdDtfComponentValidator = new SdDtfComponentValidator(createComponentList({
        attributes: [ factory.createAttributes({}) ],
...
/** Helper functions */
function createComponentList (partialList: Partial<ISdDtfPartialComponentList>): ISdDtfPartialComponentList {
    return {
        accessors: (partialList.accessors) ? partialList.accessors : [],
        asset: (partialList.asset) ? partialList.asset : new SdDtfPartialAsset(),
        ...
        fileInfo: new SdDtfPartialFileInfo(),
