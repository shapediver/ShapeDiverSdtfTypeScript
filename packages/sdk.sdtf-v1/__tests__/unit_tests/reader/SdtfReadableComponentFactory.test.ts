...
} from '../../../src/reader/components/SdtfReadableAttributes';
...
describe('createAttributes', function () {
    ...
    test('full attributes; should return readable attributes', () => {
        ...
        const readableAttributes = readableFactory.createAttributes(
            attributes,
            accessors,
            typeHints
        );
        ...
        const attribute: ISdtfReadableContentComponent = Object.values(
            readableAttributes.entries
        )[0];
